          ...
          {plantsArray.map((category, index) => (
            ...
            return    (
                  <div className="product-card" key={plantIndex}>
                    ...
                    <button  className={`product-button ${isInCart ? 'added-to-cart' : ''}`} // Add a class when added
                        onClick={() => handleAddToCart(plant)}
                        disabled={isInCart} // Disable the button if in cart
                      >
                        {isInCart ? 'Added to Cart' : 'Add to Cart'} {/* Change button text */}
                    </button>
                  </div>
                )})}
              </div>
